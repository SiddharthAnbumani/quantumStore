...
export default function EditProduct() {
  ...
  return (
    <div className='h-screen w-full flex flex-col justify-center items-center'>
      <div className="bg-black/40 h-[70%] w-[600px] backdrop-blur-3xl rounded-3xl">
        <h1 className='text-7xl font-bold text-white text-center'>Edit Product</h1>
        <div className="flex flex-col items-center justify-center">
          <form onSubmit={handleSubmit} className='w-full self-center'>
            <Input
            ...
            <div className="flex justify-center w-full space-x-5 self-center">
              <div className="w-1/3">
                <label htmlFor="Description" className="text-lg font-bold text-white">Description :</label>
              </div>
              <div className="w-2/3">
                <textarea
            ...
            <div className="flex items-center justify-center space-x-5 my-5">
              <div className="w-1/3">
                <label htmlFor="category" className="text-lg font-bold text-white">Category :</label>
              </div>
              <div className="w-2/3">
                <select
                  onChange={handleChange}
                  value={productData.Category}
                  className="bg-white px-10 py-2 rounded-2xl text-white"
                  name="Category"
                  id="category"
                >
            ...
            <div className="flex flex-col items-center space-y-4">
              <CusButton
                text='Update Product'
                btnClass='bg-yellow-500 w-[60%] px-10 py-2 text-white '
                type='submit'
                />
              <CusButton
                text='Delete Product'
                btnClass='bg-red-600 w-[60%] text-white'
                onClick={handleDelete}
                />

              <NavLink 
              className='py-2 w-[60%] bg-blue-700 font-bold text-white text-lg
              rounded-xl hover:scale-110 transition-all duration-150 text-center' 
